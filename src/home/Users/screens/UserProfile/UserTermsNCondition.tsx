...
const UserTermsNCondition = () => {
    ...
    const fetchTermsAndCondition = async () => {
        try {
            ...
            const response = await axios.get<{ data: TermsAndConditionData }>(
                `${IPA_BASE}/cms/terms-of-service`,
                {
        ...
        <SafeAreaView className='flex-1 bg-gray-50' edges={['top']}>
            ...
            {!isLoading && error && (
                <View className='flex-1 items-center justify-center px-6'>
                    ...
                    <TouchableOpacity
                        onPress={fetchTermsAndCondition}
                        activeOpacity={0.7}
                ...
                >
                    ...
                    <View className='mb-4'>
                        <Text className='text-sm text-gray-400 text-center'>
                            Last updated: {formatDate(termsData.updatedAt)}
                        </Text>
                    </View>
                </ScrollView>
            )}
...
export default UserTermsNCondition